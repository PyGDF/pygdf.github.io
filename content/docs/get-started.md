...
Папку ```tools``` не трогайте, там всего лишь находится python скрипт сборки вашей программы, и в ней же будут храниться временные файлы и папки при сборке проекта. Просто игнорируйте эту папку. Пожалуйста.</br>
</br>
...
Можете просто подсматривать исходный код, чтобы лучше понять принцип работы той или иной функции.</br>
</br>
