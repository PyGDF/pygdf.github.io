...
## 0. О PyGDF
PyGDF является шаблонным проектом в котором есть ядро ```gdf``` на котором идёт основной акцент.</br>
PyGDF последней версии работает только на Windows и MacOS системах.</br>
К каждой новой версии ядра PyGDF прикладывается документация на этом сайте.</br>
