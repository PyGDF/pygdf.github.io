...
NumPy версии 2.0.0 и выше, не дружит с PyOpenGL и PyOpenGL_accelerate, из-за чего работа некоторых функций фреймворка могут выдавать критические ошибки. По этому если вы знаете что у вас установлен NumPy версии 2.0.0 и выше, пожалуйста, переустановите его при помощи консольной команды
