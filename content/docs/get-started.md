...
PyGDF последней версии работает только на ```Windows``` и ```MacOS``` системах.</br></br>
К каждой новой версии ядра PyGDF прикладывается документация на этом сайте.</br></br>
