...
> #### Описание версии:
> Фреймворк (и ядро) работают только на <code>Windows</code> системе. <code>Unix</code> подобные не поддерживаются.</br></br>
> 
> Эта версия предназначена в основном только для работы с 2D графикой.</br></br>
> 
> Так как это первая версия, возможно что в ней всё ещё есть проблемы.</br>
> Убедительная просьба сообщить [мне](https://t.me/mr_lukov) если найдёте проблемы или баги при работе с ядром.</br>
...
> А также, если заметите ошибки в этой документации, сообщите мне. Но с хештегом <code>#docs_mistake</code></br>
> </br>
> За сотрудничество вы не только сделаете этот проект лучше, но и поможете другим людям ❤️

</br></br>

#### Ядро требует установки определённых библиотек с определёнными версиями
