...
Подмодуль звука содержит различные скрипты и классы для работы со звуком.</br>
</br><p>
Примечание:</br>
Если вы хотите чтобы был эффект пространственного звука, вам нужны аудио-файлы с расширением <code>.wav</code> или <code>.ogg</code></br>
Только с таким расширением. Другие расширения не будут поддаваться пространственному звуку.</br>
Даже если вы конвертируете их в этот формат файла. Поэтому важно иметь оригинальные аудиофайлы.</br>
Если ваш звук не поддаётся пространственному эффекту, значит этот файл был конвертирован. Считайте его испорченным.
</p></section>
